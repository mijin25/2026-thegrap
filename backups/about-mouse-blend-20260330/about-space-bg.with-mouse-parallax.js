/**
 * ABOUT 우주 배경 — about.html.bak-20260330-105948 백업과 동일
 * 성운(가우시안 블롭) + 별 패럴랙스 + 필름 그레인 · WebGL1
 * ABOUT 배경은 우주 캔버스만 (유체 레이어 없음)
 */
    ...
    (function () {
      ...
      (function loop(ts) {
        ...
        gl.uniform2f(gl.getUniformLocation(prog, 'uMouse'),      smooth.x, smooth.y);
